...
- **study_region.tif:** raster do MapBiomas (coleção 7.1, ano 2020) cortado para a região de abrangência dos seis municípios amostrados da Região Metropolitana de Manaus. O raster original do Brasil foi baixado pelo link <https://storage.googleapis.com/mapbiomas-public/brasil/collection-71/lclu/coverage/brasil_coverage_2020.tif>.
